                ...
                <div className="flex flex-col sm:flex-row items-end gap-4 lg:gap-6">
                  ...
                  <div className="w-full sm:w-auto">
                    <button
                      ...
                      className={`w-full sm:w-auto px-8 py-3.5 rounded-md text-[12px] font-bold transition-all active:scale-95 whitespace-nowrap ${loading
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                  ...
                  <div className="sm:col-span-2 mt-4 flex items-center justify-between p-5 bg-gray-50/50 border border-gray-200 rounded-lg">
                    ...
                    <button
                      ...
                      className={`px-8 py-3 rounded-md text-[12px] font-bold transition-all ${loading
                        ? 'opacity-50 cursor-not-allowed bg-gray-100 text-gray-400'
                        : isEditingFixed
                ...
                <div className="mb-8 border border-gray-100 rounded-lg overflow-hidden bg-gray-50/20">
                  ...
                  >
                    <div className="p-6 pt-0">
                      ...
                      <div className="max-h-60 overflow-y-auto pr-2 custom-scrollbar bg-white border border-gray-100 rounded-lg shadow-inner">
                        <table className="w-full text-left">
                          <tbody className="divide-y divide-gray-50">
                            {sortedMappings.length > 0 ? sortedMappings.map((m) => (
                              <tr key={m.id} className="group/row hover:bg-gray-50/50 transition-colors">
                                <td className="py-3 px-4 font-sans font-bold text-[13px] text-[#171717]">{m.item_name}</td>
                                ...
                                <td className="py-3 px-4 text-right">
                                  <div className="flex items-center justify-end gap-3 opacity-0 group-hover/row:opacity-100 transition-all">
                                    <button onClick={() => editMapping(m)} className="p-1.5 text-gray-300 hover:text-blue-500 hover:bg-white rounded-md transition-all shadow-sm border border-transparent hover:border-gray-100">
                                      <PencilLine size={14} weight="bold" />
                                    </button>
                                    <button onClick={() => deleteMapping(m.id)} className="p-1.5 text-gray-300 hover:text-red-400 hover:bg-white rounded-md transition-all shadow-sm border border-transparent hover:border-gray-100">
                ...
                <div className="space-y-4 mb-8 p-5 bg-gray-50/50 border border-gray-200 rounded-lg">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
                    ...
                    <button
                      ...
                      className={`flex items-center justify-center gap-2 px-6 py-3.5 bg-blue-600 hover:bg-blue-700 text-white rounded-md text-[13px] font-bold transition-all shadow-lg shadow-blue-200 active:scale-95 lg:mt-0 ${loading ? 'opacity-50 shadow-none' : ''}`}
                    >
                      {loading ? 'Processing...' : (
                        <>
