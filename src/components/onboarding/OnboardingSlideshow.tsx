    ...
    <Background>
      <div className="w-full min-h-screen flex items-center justify-center p-6 font-sans relative">
        <motion.div 
          ...
          className="w-full max-w-[440px] bg-white rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.08)] border border-gray-100 flex flex-col relative"
        >
          ...
          <div className="h-[260px] w-full bg-white relative flex items-center justify-center overflow-hidden border-b border-gray-100/50">
            ...
            <AnimatePresence mode="wait" custom={direction}>
              <motion.div
                ...
                className="relative z-10 w-56 h-56 flex items-center justify-center text-center p-2"
              >
                <img
            ...
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                <div className="px-3 py-1 bg-blue-50 border border-blue-100 rounded-full mb-6">
                  <span className="text-blue-700 text-[11px] font-bold tracking-wider uppercase">
                ...
                <div className="flex gap-3 w-full mt-2">
                  {currentIndex > 0 && (
                    <button
                      onClick={handlePrev}
                      className="flex-1 py-3.5 border border-[#E5E5E5] hover:bg-[#F5F5F5] rounded-xl text-[#737373] hover:text-[#171717] text-[14px] font-bold tracking-wider transition-all cursor-pointer"
                    >
                      PREVIOUS
                    </button>
                  )}
                  <button 
                    onClick={handleNext}
                    className="flex-1 py-3.5 bg-blue-600 hover:bg-blue-700 rounded-xl text-white text-[14px] font-bold transition-all flex items-center justify-center active:scale-98 shadow-sm cursor-pointer"
                  >
