              ...
              {choices.map((item, idx) => {
                ...
                return (
                  <div
                    ...
                    className={`relative p-5 cursor-pointer flex flex-col items-center justify-center text-center transition-all duration-300 ease-in-out ${!isSelected && idx !== 2 ? 'md:border-r border-b md:border-b-0 border-gray-100 ' : ''
